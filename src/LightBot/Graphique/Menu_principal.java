...
public class Menu_principal {
	...
	{  
		...
		try {
			texSon[0].loadFromStream(Utils.getInputStream("LightBot/Img/son.png"));
			texSon[1].loadFromStream(Utils.getInputStream("LightBot/Img/son_coupe.png"));
			monFond.loadFromStream(Utils.getInputStream("LightBot/Img/fond_menu.png"));
			texRetour.loadFromStream(Utils.getInputStream("LightBot/Img/retour2.png"));
		...
		for (int i=0; i< this.nbBoutons*2 ; i++)
		{
			...
			try {
				if(i<nbBoutons)
				{
					mesTextures[i].loadFromStream(Utils.getInputStream("LightBot/Img/00"+i+".png"));
				...
				{
					mesTextures[i].loadFromStream(Utils.getInputStream("LightBot/Img/00"+(i-this.nbBoutons)+"_select.png"));
				}
			} catch (IOException e) {
	...
	public static void main(String[] args) {
		...
		try {
			icon.loadFromStream(Utils.getInputStream("LightBot/Img/BB8_tete.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
