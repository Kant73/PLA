...
public class Menu_niveaux extends Menu_modes{
	...
	{  
		...
		try {
			maTexture.loadFromStream(Utils.getInputStream("LightBot/Img/numero_level.png"));
			maTextureSel.loadFromStream(Utils.getInputStream("LightBot/Img/numero_level_selec.png"));
		...
		for (int i=0; i< this.nbBoutons*2 ; i++)
		{
			...
			try {
				if(i<nbBoutons)
				{
					mesTextures[i].loadFromStream(Utils.getInputStream("LightBot/Img/numero_level_"+(i+1)+".png"));
				...
				{
					mesTextures[i].loadFromStream(Utils.getInputStream("LightBot/Img/numero_level_"+(i-this.nbBoutons+1)+"_selec.png"));
				}
