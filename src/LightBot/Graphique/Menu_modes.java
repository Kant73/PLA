...
public class Menu_modes extends Menu_principal{
	...
	{	
		...
		try {
			...
			{
			case 0:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Basic.png"));
				break;
			case 1:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Procedure.png"));
				break;
			case 2:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Loop.png"));
				break;
			case 3:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Condition.png"));
				break;
			case 4:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Star.png"));
				break;
			case 5:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Memory.png"));
				break;
			case 6:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Clone.png"));
				break;
			case 7:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Battle.png"));
				break;
			case 8:
				fondMode.loadFromStream(Utils.getInputStream("LightBot/Img/Tri.png"));
				break;
			default :
	...
	{  
		...
		for (int i=0; i< this.nbBoutons*2 ; i++)
		{
			...
			try {
					if(i<nbBoutons)
					{
						mesTextures[i].loadFromStream(Utils.getInputStream("LightBot/Img/mode00"+i+".png"));
					...
					{
						mesTextures[i].loadFromStream(Utils.getInputStream("LightBot/Img/mode00"+(i-this.nbBoutons)+"_select.png"));
					}
