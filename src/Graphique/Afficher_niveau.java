...
public class Afficher_niveau extends Menu_niveaux{
	...
	/**
	 * Permet d'afficher les cadres pour les proc�dures (dont le main)
	 */
	...
	/**
	 * M�thode principale de la classe qui permet d'afficher tout un niveau avec les actions et proc�dures associ�e
